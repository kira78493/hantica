...
<html>
<head>
  <title>Hvala vam na porudžbini!</title>
  ...
  <div class="content">
    <div class="row">
      ...
      <div class="col-lg-10 col-md-10 col-sm-10 col-xs-12">
        <h2 class="success_page_main_title">Hvala vam na porudžbini!</h2>
        <div class="success_page_top_message">Naš operater će vas kontaktirati u roku od jednog radnog dana.</div>
        <h3 class="success_page_bottom_message">Molim vas, uključite vaš telefon.</h3>
